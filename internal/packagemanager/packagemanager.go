...
// UninstallPackageManagerDockerRepos uninstalls docker repos installed by package managers
func (pm *DistroPackageManager) UninstallPackageManagerDockerRepos() error {
